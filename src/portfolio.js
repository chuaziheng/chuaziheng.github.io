...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1OIGhJqc3ZAGF04dvXNQ8DS1IBw4zLAVH/view?usp=sharing", // Set to empty to hide the button
...
const skillsSection = {
  title: "What I do",
  subTitle: "20% training models, 30% cleaning data and 50% on stackoverflow",
  skills: [
    emoji(
      "⚡ End-to-end machine learning pipeline from data collection, model training to model deployment"
    ),
    emoji("⚡ Experience in Computer Vision, exploring NLP and Recommender Systems"),
    emoji(
      "⚡  Big data analytics using Hadoop ecosystem (still learning)"
    )
  ],
